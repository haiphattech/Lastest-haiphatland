        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" placeholder="" name="name"
                               value="{{old('name', $typeProject['name'])}}">
                        @if ($errors->has('name'))
                        ...
                        <div class="form-check" style="margin-top: 5px;">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input"
                                       {{$typeProject['status'] ? "checked" : ''}} value="{{$typeProject['status']}}" name="status">
                ...
                <div class="text-center">
                    ...
                    <a href="{{route('type-projects.index')}}" class="btn btn-dark">Quay lại</a>
                </div>
            </div>
        </div>
    </div>
